  ...
  return (
    <div>
      ...
      <div className="riskAssWrapper">
        <div className="riskAssHeader">Risk Assessment Quiz</div>
        <div>
        ...
        <div>
          <label class="label">
            I would risk this share of my portfolio in exchange for the same probability of doubling
            my money:
          </label>
        ...
        <div class="riskLevel">
          {visible && (
            <div class="riskLevel">
              ...
              <text style={{ color: riskColor }}>{risk}</text>
            </div>
          )}
        </div>

        <div class="showError">{error && <div class="label">The form is incomplete</div>}</div>
      </div>
    </div>
  );
}
